 ...
 */
@XmlRootElement(name = "AddEventToNewStepRequest", namespace = "http://www.globality.com.br/gam/engine/common/request")
@XmlType(
		name = "AddEventToNewStepRequest", 
		namespace = "http://www.globality.com.br/gam/engine/common/request",
		propOrder={
