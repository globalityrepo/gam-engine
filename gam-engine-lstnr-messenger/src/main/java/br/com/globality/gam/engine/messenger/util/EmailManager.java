package br.com.globality.gam.engine.messenger.util;
...
@Scope("prototype")
@PropertySource("file:/gam/config/application.properties")
public class EmailManager {
	...
	public void sendMail(String emailTo, String subject, String message) throws Exception {
		...
		try {			
			...
			InternetAddress from = new InternetAddress("GAM - Globality API Manager <" + env.getProperty("email.username") + ">");
			msg.setFrom(from);
