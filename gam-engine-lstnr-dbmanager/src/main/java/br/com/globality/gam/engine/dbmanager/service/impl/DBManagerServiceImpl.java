package br.com.globality.gam.engine.dbmanager.service.impl;
...
import br.com.globality.gam.engine.common.domain.Aplicacao;
import br.com.globality.gam.engine.common.domain.ConfiguracaoSistema;
import br.com.globality.gam.engine.common.domain.EventoInstancia;
import br.com.globality.gam.engine.common.domain.EventoInstanciaConteudo;
import br.com.globality.gam.engine.common.domain.EventoTipo;
import br.com.globality.gam.engine.common.domain.TransacaoGrupo;
import br.com.globality.gam.engine.common.domain.TransacaoInstancia;
import br.com.globality.gam.engine.common.domain.TransacaoParametro;
import br.com.globality.gam.engine.common.domain.TransacaoParametroValor;
...
import br.com.globality.gam.engine.common.domain.TransacaoPassoEventoNivel;
import br.com.globality.gam.engine.common.domain.TransacaoPassoInstancia;
import br.com.globality.gam.engine.common.domain.compositeId.TransacaoParametroValorCompositeId;
import br.com.globality.gam.engine.common.domain.compositeId.TransacaoPassoAcaoTodoCompositeId;
...
import br.com.globality.gam.engine.common.type.ParameterType;
...
import br.com.globality.gam.engine.dbmanager.dao.DBManagerDAO;
import br.com.globality.gam.engine.dbmanager.dao.GenericDAO;
import br.com.globality.gam.engine.dbmanager.service.DBManagerService;
...
public class DBManagerServiceImpl implements DBManagerService {
	...
	public void execute(String envXml) throws ServiceException, BusinessException {		
		...
		try {			
			...
			GAMEnvelopeType envObj = (GAMEnvelopeType) CommonUtils.convertXmlToObj(envXml, GAMEnvelopeType.class);
	...
	private String addEvent(GAMEnvelopeType envObj, TransacaoGrupo transacaoGrupo) throws ServiceException, ValidationException {
	...
	@Transactional(propagation = Propagation.MANDATORY, rollbackFor = {ServiceException.class, ValidationException.class})
	private void addEventContent(GAMEnvelopeType envObj) throws ServiceException, ValidationException {
	...
	private void addEventParameters(GAMEnvelopeType envObj, TransacaoGrupo transacaoGrupo) throws ServiceException {
		try {
	...
	@Transactional(propagation = Propagation.MANDATORY, rollbackFor = {ServiceException.class, ValidationException.class})
	private void checkActionToDo(GAMEnvelopeType envObj, TransacaoPasso transacaoPasso, boolean hasConteudo) throws ServiceException, ValidationException {		
	...
	@Transactional(propagation = Propagation.MANDATORY, rollbackFor = {ServiceException.class})
	private void sendMailAction(GAMEnvelopeType envObj, TransacaoPassoAcao acaoPlan, int acao) throws ServiceException {
		...
		try {
			...
			envelope.setGamEnvelope(envObj);
