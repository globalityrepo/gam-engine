package br.com.globality.gam.engine.doretry.executor;
...
import br.com.globality.gam.engine.doretry.service.DoRetryService;
import br.com.globality.gam.engine.doretry.task.DoRetryTask;

/**Listenner para execução de retries da engine do GAM.
