package br.com.globality.gam.engine.logwriter.service.impl;
...
import br.com.globality.gam.engine.logwriter.dao.GenericDAO;
import br.com.globality.gam.engine.logwriter.dao.LogWriterDAO;
import br.com.globality.gam.engine.logwriter.service.LogWriterService;

/**
 * Classe de regras de negócio da tarefa de escrita de arquivo texto da engine do GAM.
 * 
...
public class LogWriterServiceImpl implements LogWriterService {
	...
	*/
	...
	public void writeTrxLogFile(final String DIR_PATH, GAMEnvelopeType envObj) throws ServiceException {
		...
		final String 	 FILE_NAME = "GAM_" + DF_FILE.format(new Date()) + ".csv";
